...
<head>
  ...
  <!-- Web Page Title -->
  <title>Checkout | Groceria - Online Grocery Shop</title>
  <!-- Favicon -->
                  ...
                  <table class="table">
                    <tbody>
                      <tr>
                        ...
                        <td class="text-end" >RS. 700.00/-</td>
                      </tr>
                      <tr>
                        <td>
                          <strong>1 x Nescafé Coffee Jar</strong>
                        </td>
                        <td class="text-end" >RS. 195.00/-</td>
                      </tr>
                      <tr>
                        <td>
                          <strong>1 x Lays Potato Chips</strong>
                        </td>
                        <td class="text-end" >RS. 60.00/-</td>
                      </tr>
                      <tr>
                        <td>
                      ...
                      <tr>
                        ...
                        <td class="text-end" >RS. 780.00/-</td>
                      </tr>
                      <tr>
                        <td>
